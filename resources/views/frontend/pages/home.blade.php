...
<div>
  <div>
    <div>
    <span style="font-size:1.2rem">Welcome to </span><h1 class="my-4 text-center" style="display:inline-block;font-size:1.2rem;">Sand Blasting Hopper Manufacturer's in India</h1>
    ...
    <div class="row" id="data_align">
      <div class="col-lg-7">
        ...
        <div class="side-contant">
          <div class="m8 sw1">
            <img src="imgs/hopper.jpg" ALT="" class="side-img-brdr" ></div>
