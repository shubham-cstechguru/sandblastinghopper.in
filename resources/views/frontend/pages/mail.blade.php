                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="{{ url('/') }}" style="display: block; border-style: none !important; border: 0 !important;">
                                            <img width="80" border="0" style="display: block; width: 80px;" src="{{ url('imgs/'.$s->logo) }}" alt="" />
                                        </a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            Thank you for sending message our team is contact you in as soon as possible regarding your message<br>
                                        ...
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            You Recived Mail From {{ $req->user_name }}<br>
                                            
                                            Mobile : {{ $req->user_mobile }}<br>
                                            Email : {{ $req->user_email }}<br>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <a href="{{ url('/') }}" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" src="{{ url('imgs/'.$s->logo) }}" alt="" /></a>
                                                </td>
                                            </tr>
