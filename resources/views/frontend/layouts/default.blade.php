...
<body class="">
   <div class="container show_body">
  	...
  	@section('footer')
        ...
        <p class="text-white text-center mt-5">Copyright &copy; All rights reserved Sandblasting hopper. Website Design and Developed by <a href="https://www.suncitygroup.org/" target="_blank">Suncity Group</a></p>
    ...
    <div class="modal-content">
        ...
        <p id="ajax_message"></p>
                        ...
                        <div class="modal-body mx-3">
                            ...
                            <div class="md-form">
                                <label data-error="wrong" data-success="right" for="user_country" style="float:left;">Your Country</label>
                                {{ Form::tel('user_country', '', ['class' => 'form-control validate', 'id'=>'user_country', 'placeholder'=>'User country','required'=>'required'])}}
                            </div>
