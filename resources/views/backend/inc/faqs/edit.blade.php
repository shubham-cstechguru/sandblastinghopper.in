...
@section('contant')
		...
		<div class="page-wrapper p-5">
	        ...
	        @endif
	        <h2 style="text-align: center;">Edit Faq</h2>
	        {{ Form::open()  }}
        <div class="row"> 
			...
			<div class="col-lg-6">
				<div class="form-group">
					...
					{{Form::text('record[seo_title]', '', ['class' => 'form-control', 'id'=>'seo_title','placeholder'=>'Enter title'])}}
				</div>
			</div>
			<div class="col-lg-6">
				<div class="form-group">
					{{Form::label('seo_keywords', 'Keywords')}}
					{{Form::text('record[seo_keywords]','', ['class'=>'form-control','id'=>'seo_keywords', 'placeholder'=>'write...'])}}
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
					{{Form::label('seo_description', 'Seo Description')}}
					{{Form::textarea('record[seo_description]', '', ['class' => 'form-control', 'id'=>'seo_description', 'placeholder'=>'write...','rows'=>'4', 'col'=>'3'])}}
				</div>
