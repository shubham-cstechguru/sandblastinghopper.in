...
@section('contant')
	...
	<div class="page-wrapper p-5">
		    ...
		    <h2 style="text-align: center; padding: 20px 0;">PENDING INQUIRY</h2>
					                    ...
					                    <span>
					                        <div class="dropdown show">
                                              ...
                                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <a class="dropdown-item text-warning" href="?id={{ $list->id }}&status=Pending">Pending</a>
                                                <a class="dropdown-item text-success" href="?id={{ $list->id }}&status=Confirmed">Confirmed</a>
                                                <a class="dropdown-item" href="?id={{ $list->id }}&status=In-progress">In-progress</a>
                                              </div>
                                            </div>
                                        </span>
                                        <span class="text-warning" style="margin:auto;">{{ $list->status }}</span>
					                    </td>
