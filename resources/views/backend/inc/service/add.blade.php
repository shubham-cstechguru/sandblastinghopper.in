...
<div class="row">
	<div class="col-lg-6">
		...
		<div class="form-group">
			...
			{{Form::textarea('service_short_description', '', ['class' => 'form-control', 'id' => 'excerpt', 'placeholder'=>'Enter short description','rows'=>'6', 'col'=>'6'])}}
		</div>
	</div>
	<div class="col-lg-6">
		...
		<div class="form-group">
			{{Form::label('banner_image', ' Choose Hover image')}}
			<div class="">
